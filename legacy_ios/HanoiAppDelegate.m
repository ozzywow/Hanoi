...
//		CCLOG(@"Retina Display Not supported");
	...
	[[UserDataManager sharedUserDataManager] SetBaseView:window] ;
	[[UserDataManager sharedUserDataManager] LoadUserData];
	
	[[SoundFactory sharedSoundFactory] PlaydSound:@"intro_bgm"];
	
	
	[MKStoreManager sharedManager] ;
#ifdef AD_VER
	if( TRUE == [MKStoreManager isFeaturePurchased:kProductId1] )
	{
		[[UserDataManager sharedUserDataManager] SetCart:TRUE];
	}
#endif
